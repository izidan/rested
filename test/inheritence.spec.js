const { inheritence } = require('./fixtures');

describe('Inheritence', () => {
  beforeAll(inheritence.init);
  afterAll(inheritence.deinit);
  beforeEach(inheritence.create);
  const request = () => require('supertest')(inheritence.app());
